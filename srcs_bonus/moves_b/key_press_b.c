...
/*   Updated: 2022/12/19 13:07:26 by nadesjar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool	hit_box(t_game *game)
{
	...
	collision = false;
	if ((game->player->pos.y < (game->enemy0.pos.x + 0.5f)
			&& (game->player->pos.y + 0.5f) > game->enemy0.pos.x)
		&& (game->player->pos.x < (game->enemy0.pos.y + 0.5f)
			&& (game->player->pos.x + 0.5f) > game->enemy0.pos.y))
		{
